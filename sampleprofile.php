...
<table width="60%" border="0" align="center" cellpadding="0" style="margin-top: 10px;">
  ...
  <tr>
    ...
    <td width="82" valign="top" style="padding:6px"><div align="left"><font size="4" face="georgia">USERNAME:</div></td>
    <td width="165" valign="top" class="section-heading text-uppercase" style="padding:6px"><font size="5" face="georgia"><?php echo $uname?></font></td>
  </tr>
...
<!--<p align="center"><a href="index.php"></a></p>-->
 ...
 <table  width="450px" height="300" border="1" style="margin-left: 200px; margin-top:30px;">
  <tr><td>
    <?php
    $user ='root';
$pass='';
...
$db1= mysqli_connect('localhost',$user,$pass,$db) or  die("unable to connect");
                ...
                while($row = mysqli_fetch_array($result))
                {
                     echo '
                          <tr>
                               <td>
                                    <img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'"margin-left="255px" height="200" width="450" class="img-thumnail" />
                               </td>
                          </tr>
                     ';
                }
